...
public class UserController {
    ...
    public ResponseEntity<?> followUser(@PathVariable String id) {
        ...
        if (follower != null) {
            ...
            metadata.put("actorName", follower.getUsername());
            metadata.put("actorAvatar", follower.getAvatarUrl());
            notificationService.createNotification(
                    id, currentUserId, "NEW_FOLLOWER", "USER", currentUserId,
                    follower.getUsername() + " started following you", metadata);
        }
