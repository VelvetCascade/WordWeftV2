    ...
    <div className="pro-shell">
      ...
      <div className="pro-topbar">
        ...
        <div className="pro-topbar-actions">
          ...
          <button
            className="pro-topbar-btn"
            onClick={() => window.location.hash = `/pro/timeline/${activeProject.id}`}
          ...
          <button
            className="pro-topbar-btn"
            onClick={() => window.location.hash = `/pro/snapshots/${activeProject.id}`}
            title="Chapter Snapshots"
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="15" height="15">
          ...
          <button
            className="pro-topbar-btn"
            onClick={() => window.location.hash = `/pro/analytics/${activeProject.id}`}
