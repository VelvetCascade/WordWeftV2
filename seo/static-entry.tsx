...
export function renderStatic(path: string) {
    const pages = { '/': <FeaturesPage />, '/features': <FeaturesPage />, '/about': <AboutPage />, '/terms': <TermsPage />, '/privacy': <PrivacyPage />, '/safety': <SafetyRulesPage />, '/contact': <ContactPage currentUser={null} /> };
